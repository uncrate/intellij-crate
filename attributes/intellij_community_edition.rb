...
when "mac_os_x"
  default['intellij_community_edition']['download_url']="http://download.jetbrains.com/idea/ideaIC-12.1.6.dmg"
  default['intellij_community_edition']['checksum']="e5120d032265d7607d7932204642c012ecf2f8328b04ee52006212bc8820d6ce"

  default['intellij_community_edition']['name']="IntelliJ IDEA 12 CE"
end
